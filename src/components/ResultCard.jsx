...
export default function ResultCard({ item, recommendationsJson }) {
  ...
  const baseWidth = severityBaseWidth[item.severity] || 0;
  const dynamicWidth = Math.min(100 - baseWidth, confidencePercent);
  const totalBarWidth = baseWidth + dynamicWidth;
